    ...
    switch (interaction.options.getSubcommand()) {
      case "8ball": {
        ...
        interaction.followUp({
          content: `${answer}`
          //embeds: [new EmbedBuilder().setColor("Blue").setFooter({ text: `Requested  By ${interaction.user.username} •`, iconURL: interaction.user.displayAvatarURL({ dynamic: true }) }).setTitle(`🎱| 8ball`).setDescription(`**Question: ${question}\n\nAnswer: ${answer}**`)]
        });
      } break;
      case "": {
