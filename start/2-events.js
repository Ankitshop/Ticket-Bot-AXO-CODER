...
try {
    ...
    console.log(clc.greenBright(`     ┃ `) + clc.cyanBright(`                   Welcome to ${clc.redBright(`Ilona`)}!`) + " ".repeat(-1 + stringlength - ` ┃ `.length - `                   Welcome to Axocoder Development!`.length) + clc.greenBright("┃"))
    console.log(clc.greenBright(`     ┃ `) + " ".repeat(-1 + stringlength - ` ┃ `.length) + clc.greenBright("┃"))
    console.log(clc.greenBright(`     ┃ `) + clc.cyanBright(`             /-/ By Axocoder /-/`) + " ".repeat(-1 + stringlength - ` ┃ `.length - `             /-/ By Axocoder /-/`.length) + clc.greenBright("┃"))
    console.log(clc.greenBright(`     ┃ `) + " ".repeat(-1 + stringlength - ` ┃ `.length) + clc.greenBright("┃"))
    console.log(clc.greenBright(`     ┃ `) + clc.yellowBright(`               /-/ Discord: Axocoder  /-/`) + " ".repeat(-1 + stringlength - ` ┃ `.length - `               /-/ Discord: Axocoder  /-/`.length) + clc.greenBright("┃"))
    console.log(clc.greenBright(`     ┃ `) + " ".repeat(-1 + stringlength - ` ┃ `.length) + clc.greenBright("┃"))
    console.log(clc.greenBright(`     ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛`))
    console.log("\n")
  } catch {
