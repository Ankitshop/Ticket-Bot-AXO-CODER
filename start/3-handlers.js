...
//======== Loading Handlers =========
var counter = 0;
Array ("slashCommandHandler.js", "messageCommandHandler.js", client.config.source.keep_alive ?  "keepAlive.js" : null, "extraEvents.js", client.config.source.anti_crash ? "antiCrash.js" : null)
  .filter(Boolean)
  .forEach((handler) => {
